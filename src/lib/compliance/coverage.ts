...
const COVERAGE_NOTES: Record<string, Record<CoverageStatus, string>> = {
  lni_violations: {
    verified:     'Source-backed monitoring active — violations data retrieved from Philadelphia L&I Open Data.',
    ...
    pending:      'No records found in monitored sources — L&I violations API queried successfully; no violations on file. Verify at https://li.phila.gov if unexpected.',
    unavailable:  'Source unavailable — L&I violations data could not be retrieved (API error). Pending verification.',
  },
  rental_license: {
    verified:     'Source-backed monitoring active — rental license status confirmed via Philadelphia Business License data.',
    ...
    pending:      'No records found in monitored sources — rental license API queried; no matching license found. Pending verification at https://li.phila.gov.',
    unavailable:  'Source unavailable — rental license data could not be retrieved (API error). Pending verification.',
  },
  cert_of_rental_suitability: {
    ...
    rule_derived: 'Required per Philadelphia Code § 9-3902; not tracked in public Open Data. Coverage not yet active for this item — verify manually.',
    pending:      'Pending verification — certificate status unknown. Verify with Philadelphia L&I.',
    unavailable:  'Coverage not yet active in this jurisdiction for this item.',
  },
  permits_history: {
    verified:     'Source-backed monitoring active — building permit history retrieved from Philadelphia Open Data.',
    ...
    pending:      'No records found in monitored sources — no permit history in the past 2 years.',
    unavailable:  'Source unavailable — permit history data could not be retrieved (API error). Pending verification.',
  },
  inspections: {
    verified:     'Source-backed monitoring active — inspection history retrieved from Philadelphia L&I Open Data.',
    partial:      'Some inspection records found; may not reflect all inspections.',
    rule_derived: 'Inspection history not applicable.',
    pending:      'No records found in monitored sources — no inspection records on file for this address.',
    unavailable:  'Source unavailable — inspection data could not be retrieved (API error). Pending verification.',
  },
};
